...
export default function ReportsPage() {
  ...
  const [costCenter, setCostCenter] = useState("");   // Novo
  const [costCenters, setCostCenters] = useState([]); // Novo
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
            ...
            <div>
              ...
              <Select value={costCenter} onValueChange={setCostCenter}>
                ...
                <SelectContent>
                    <SelectItem value="todos">Todos os Centros de Custos</SelectItem> {/* <-- aqui */}
                    {(
                    costCenters.map((cc) => (
